# Motion Detection with hysteresis; capture transition frames in files; post to Dweet

# Dweet:
# https://dweet.io/follow/vz-anil-vaidy-raja
# https://freeboard.io/board/xxxyyyzzz
...
send_dweet = False      # whether to send status changes to Dweet.io
---------------------------------------------------------------------- 
'''
