# For simulation only: Mark dot positions in 2 colors, and display them as occupied or vacant 
# This is how the final outcome of parking finder application may look like, when completed
...
annotated_file = 'Annotated2.jpg'
cv2.imwrite(annotated_file, img)
print 'image saved as:', annotated_file
