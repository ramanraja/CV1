# Cut off circular zones from an image and get masked B,G,R histograms; Save the histograms to a CSV file
...
pickle_file = 'Repaired_pickle1.p' # 'pickle2.p' 
...
feature_file = open('features1.csv', 'wt') 
plt.figure()
