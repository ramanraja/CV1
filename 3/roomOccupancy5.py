# Motion Detection; average of previous frames; hysteresis; JSON configuration file
...
# capture changed frames in files
# TODO: debug: the time to declare 'free' stretches 3 times if you close the camera lens !
...
max_idle_count = int(1000.0/frame_delay * max_idle_time)  # how many frames to
     # wait (hysteresis) before you declare the room to be free 
...
while True:
	...
	if avg is None:
		print "initializing..", idle_time_counter
	...
	for c in cnts:
		...
		print idle_time_counter," ",
		idle_time_counter = 0
		is_free = 0
	 
	# reset the running average frame, if idle wait time is crossed (hysteresis)
