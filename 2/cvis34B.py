...
the_mask = cv2.adaptiveThreshold (blurred, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY_INV, neighbourhood, cparam) 
...
cv2.imshow("Adaptive Mean Thresholded", np.hstack([img, the_mask, masked]))
